            ...
            <div className="culture-content-grid">
              <section className="culture-stories-block">
                ...
                <div className="culture-story-grid">
                  <a href="#blog" className="culture-story-card">
                    <img src={visual02} alt="Creators talking together" loading="lazy" />
                    <div><span>MUSIC</span><h4>THE VOICES DEFINING THE NEXT WAVE</h4><small>Culture Desk · Aug 2026</small></div>
                  </a>
                  <a href="#blog" className="culture-story-card">
                    <img src={visual06} alt="Editorial fashion portrait" loading="lazy" />
                    <div><span>STYLE</span><h4>WHY AFRICAN VISUAL CULTURE KEEPS MOVING FORWARD</h4><small>Culture Desk · Aug 2026</small></div>
                  </a>
                  <a href="#blog" className="culture-story-card">
                    <img src={visual12} alt="Masked artist portrait" loading="lazy" />
                    <div><span>ARTISTS</span><h4>MEET THE CREATORS MAKING THEIR OWN RULES</h4><small>Culture Desk · Aug 2026</small></div>
                  </a>
                </div>
              </section>
